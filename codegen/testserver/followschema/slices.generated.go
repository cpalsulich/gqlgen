...
func (ec *executionContext) marshalOSlices2ᚖgithubᚗcomᚋcpalsulichᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐSlices(ctx context.Context, sel ast.SelectionSet, v *Slices) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
