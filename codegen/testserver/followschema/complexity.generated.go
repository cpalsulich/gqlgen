...
func (ec *executionContext) marshalOOverlappingFields2ᚖgithubᚗcomᚋcpalsulichᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐOverlappingFields(ctx context.Context, sel ast.SelectionSet, v *OverlappingFields) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
