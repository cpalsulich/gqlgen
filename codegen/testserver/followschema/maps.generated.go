...
func (ec *executionContext) unmarshalONestedMapInput2ᚖgithubᚗcomᚋcpalsulichᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐNestedMapInput(ctx context.Context, v interface{}) (*NestedMapInput, error) {
	if v == nil {
		return nil, nil
	}
