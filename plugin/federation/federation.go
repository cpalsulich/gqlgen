...
import (
	...
	"github.com/cpalsulich/gqlgen/plugin"
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/cpalsulich/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/cpalsulich/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/cpalsulich/gqlgen/graphql.Map"},
		},
	}
